export default () => ({
  path: "/corehr/ORGANIZATION/index/list",
  scopes: [
    {
      scopeId: 1,
      data: {
          ...
          "searchParamsConfirm",
          {
            ...
            config: {
              ...
              data: {
                ...
                type: "{searchParams.search.type||undefined}",
                subType: "{searchParams.search.subType||undefined}"
              },
              $response: {
                data: {
                  instances: "{list}",
                      ...
                      },
                      {
                        ...
                        scopedSlots: {
                          default: [
                            ...
                            // {
                            //   nodeType: "el-button", innerHTML: "编辑", props: {type: "text"}, scopeMapping: {row: "row", index: "index"},
                            //   on: {click: {actionName: "toEdit", $params: {append: {data: {row: {instanceId: "{detailInstanceId}"}}}}}}
                            // }
                          ]
                        }
                      }]
