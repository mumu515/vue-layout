...
const Utils = {
    ...
    getEvalResult: (evalScope, str = "") => {
      if (str.indexOf("$") >= 0) {
        return jsonpath.value(evalScope, Utils.getEvalString(str));
      }
      ...
      let codes = Utils.getEvalString(str).split(";");
      let code1 = "", code2 = "";
      if (codes.length === 1) {
        code2 = codes[0];
      } else {
      ...
      let varsStr = Utils.getVars(Utils.getEvalString(str))
